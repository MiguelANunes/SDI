...
public class Recv {
	...
	private final static String FILA_ToServer = "input";
	private final static String FILA_ToClient = "output";
		...
		for (i = 0; i < traduzir.length(); i++){
			...
			if(Character.isUpperCase(traduzir.charAt(i))){
				...
				if(Character.isLowerCase(traduzir.charAt(i + 1))){
					...
					elemento += temp;
					// System.out.println(MapaElementos.get(elemento));
					traduzida += (char) (MapaElementos.get(elemento) + 31);
